  ...
  public static users: any[] = [
    {
      ...
      image: './assets/media/users/300_25.jpg',
      fullName: 'Sean S',
      firstName: 'Sean',
      lastName: 'Stark',
      occupation: 'CEO',
      companyName: 'TulipTechs',
      phoneNumber: '456669067890',
      language: 'en',
      timeZone: 'International Date Line West',
      website: 'https://tuliptechsui.azurewebsites.net.com',
      expiresIn: new Date('9/9/1993'),
      setAuth: () => {},
      setUser: () => {},
      emailSettings: {
        ...
        updatesFromTulipTechs: {
          newsAboutTulipTechsProductsAndFeatureUpdates: false,
    ...
    },
    {
      ...
      roles: [2], // Manager
      image: './assets/media/users/100_2.jpg',
      fullName: 'Megan F',
      firstName: 'Megan',
      lastName: 'Fox',
      occupation: 'Deputy Head of TulipTechs in New York office',
      companyName: 'TulipTechs',
      phoneNumber: '456669067891',
      language: 'en',
      timeZone: 'International Date Line West',
      expiresIn: new Date('9/9/1993'),
      setAuth: () => {},
    ...
    },
    {
      ...
      roles: [3], // Guest
      image: './assets/media/users/default.jpg',
      fullName: 'Manu G',
      firstName: 'Manu',
      lastName: 'Ginobili',
      occupation: 'CFO',
      companyName: 'TulipTechs',
      phoneNumber: '456669067892',
      language: 'en',
      expiresIn: new Date('9/9/1993'),
      setAuth: () => {},
      setUser: () => {},
